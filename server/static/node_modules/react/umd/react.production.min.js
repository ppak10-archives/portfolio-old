...
(function (D, k) {
  ...
  function X(a, b, c) {
    var d = void 0,
        ...
        e = null,
        f = null;
    if (null != b) for (d in void 0 !== b.ref && (f = b.ref), void 0 !== b.key && (e = "" + b.key), b) Y.call(b, d) && !Z.hasOwnProperty(d) && (g[d] = b[d]);
    var h = arguments.length - 2;
    if (1 === h) g.children = c;else if (1 < h) {
      for (var k = Array(h), n = 0; n < h; n++) k[n] = arguments[n + 2];

      g.children = k;
    }
    if (a && a.defaultProps) for (d in h = a.defaultProps, h) void 0 === g[d] && (g[d] = h[d]);
    return {
      $$typeof: r,
      type: a,
      key: e,
  ...
  function L(a, b, c, d) {
    ...
    if (Array.isArray(a)) for (var f = 0; f < a.length; f++) {
      ...
      var h = b + M(g, f);
      e += L(g, h, c, d);
    } else if (null === a || "object" !== typeof a ? h = null : (h = ca && a[ca] || a["@@iterator"], h = "function" === typeof h ? h : null), "function" === typeof h) for (a = h.call(a), f = 0; !(g = a.next()).done;) g = g.value, h = b + M(g, f++), e += L(g, h, c, d);else "object" === g && (c = "" + a, k("31", "[object Object]" === c ? "object with keys {" + Object.keys(a).join(", ") + "}" : c, ""));
    return e;
  }
  ...
  var W = {
    ...
    didTimeout: !1
      ...
      ha = "function" === typeof cancelAnimationFrame ? cancelAnimationFrame : void 0,
      ia,
      ja,
      ka = function (a) {
    ia = fa(function (b) {
  ...
  } else if (window._schedMock) f = window._schedMock, J = f[0], I = f[1], q = f[2];else {
  ...
  y(f, {
    Schedule: {
      ...
      unstable_scheduleWork: function (a, b) {
        ...
        if (null === e) e = a.next = a.previous = a, F(e);else {
          c = null;
          var d = e;
