...
(function (l, n) {
  "object" === typeof exports && "undefined" !== typeof module ? module.exports = n(require("react"), require("react-dom")) : "function" === typeof define && define.amd ? define(["react", "react-dom"], n) : l.ReactTestUtils = n(l.React, l.ReactDOM);
})(this, function (l, n) {
  function H(a, b, c, e, d, f, g, h) {
    if (!a) {
      a = void 0;
  ...
  function k(a) {
    for (var b = arguments.length - 1, c = "https://reactjs.org/docs/error-decoder.html?invariant=" + a, e = 0; e < b; e++) c += "&args[]=" + encodeURIComponent(arguments[e + 1]);
  ...
  function J(a) {
    var b = a.alternate;
    if (!b) return b = A(a), 3 === b ? k("188") : void 0, 1 === b ? null : a;
    ...
    for (var c = a, e = b;;) {
      ...
      c.alternate !== e ? k("190") : void 0;
    }

    5 !== c.tag ? k("188") : void 0;
  ...
  function L(a) {
    a instanceof this ? void 0 : k("279");
    a.destructor();
  ...
  function y(a) {
    ...
    for (c in b) if (b.hasOwnProperty(c) && c in D) return z[a] = b[c];
  ...
  function M(a, b) {
    ...
    for (var c = a, e = [];;) {
      if (7 === c.tag || 8 === c.tag || 2 === c.tag || 3 === c.tag || 0 === c.tag || 1 === c.tag) {
        var d = c.stateNode;
        b(d) && e.push(d);
      }
  ...
  function N(a) {
    return function (b, c) {
      ...
      g.persist();
      u(g, c);
      e.phasedRegistrationNames ? P(g) : Q(g);
  ...
  function U(a, b) {
    return function (c, e) {
      var d = new E(a);
      u(d, e);
      f.isDOMComponent(c) ? (c = V(c), d.target = c, G(b, d)) : c.tagName && (d.target = c, G(b, d));
    };
  }

  var u = l.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.assign;
  u(t.prototype, {
  ...
  var m = !("undefined" === typeof window || !window.document || !window.document.createElement),
    ...
    transitionend: x("Transition", "TransitionEnd")
      ...
      z = {},
      D = {};
  m && (D = document.createElement("div").style, "AnimationEvent" in window || (delete r.animationend.animation, delete r.animationiteration.animation, delete r.animationstart.animation), "TransitionEvent" in window || delete r.transitionend.transition);
  m = y("animationend");
  var W = y("animationiteration"),
      X = y("animationstart"),
      Y = y("transitionend"),
      V = n.findDOMNode,
    ...
    findAllInRenderedTree: function (a, b) {
      q(a, "findAllInRenderedTree");
      return a ? M(a._reactInternalFiber, b) : [];
    },
    scryRenderedDOMComponentsWithClass: function (a, b) {
      q(a, "scryRenderedDOMComponentsWithClass");
    ...
    findRenderedDOMComponentWithClass: function (a, b) {
      q(a, "findRenderedDOMComponentWithClass");
