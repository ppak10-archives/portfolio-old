...
function I(a) {
  ...
  if ("object" === typeof a) {
    ...
    if ("function" === typeof a.then && (a = 1 === a._reactStatus ? a._reactResult : null)) return I(a);
  }
...
["checked", "multiple", "muted", "selected"].forEach(function (a) {
  O[a] = new N(a, 3, !0, a, null);
});
["capture", "download"].forEach(function (a) {
  O[a] = new N(a, 4, !1, a, null);
});
["cols", "rows", "size", "span"].forEach(function (a) {
  O[a] = new N(a, 6, !1, a, null);
});
...
function ua(a, b) {
  function d(c, g) {
    ...
    if ("function" === typeof e.getChildContext && (d = g.childContextTypes, "object" === typeof d)) {
      ...
      for (var w in c) w in d ? void 0 : t("108", I(g) || "Unknown", w);
    }
...
var Z = function () {
  ...
  a.prototype.render = function (a, d, c) {
    ...
    t("130", null == b ? b : typeof b, "");
  };

  a.prototype.renderDOM = function (a, d, c) {
    var b = a.type.toLowerCase();
    c === S.html && T(b);
    X.hasOwnProperty(b) || (na.test(b) ? void 0 : t("65", b), X[b] = !0);
    var f = a.props;
    if ("input" === b) f = p({
      type: void 0
    }, f, {
    ...
    if (k = f) ia[b] && (null != k.children || null != k.dangerouslySetInnerHTML ? t("137", b, "") : void 0), null != k.dangerouslySetInnerHTML && (null != k.children ? t("60") : void 0, "object" === typeof k.dangerouslySetInnerHTML && "__html" in k.dangerouslySetInnerHTML ? void 0 : t("61")), null != k.style && "object" !== typeof k.style ? t("62", "") : void 0;
    k = f;
    l = this.makeStaticMarkup;
    D = 1 === this.stack.length;
    z = "<" + a.type;

    for (u in k) if (ra.call(k, u)) {
      var e = k[u];
      ...
      if (null != e) {
        ...
        if (m) sa.hasOwnProperty(u) || (h = u, h = M(h) && null != e ? h + "=" + ('"' + R(e) + '"') : "");else {
          m = u;
          h = e;
...
var wa = function (a) {
  ...
  renderToString: function (a) {
    return new Z(a, !1).read(Infinity);
  },
  renderToStaticMarkup: function (a) {
    return new Z(a, !0).read(Infinity);
  },
