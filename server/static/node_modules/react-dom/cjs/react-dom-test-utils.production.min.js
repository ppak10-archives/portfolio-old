...
var W = {
  ...
  findAllInRenderedTree: function (a, b) {
    ...
    return a ? ca(a._reactInternalFiber, b) : [];
  },
...
function da(a) {
  return function (b, c) {
    ...
    f.persist();
    g(f, c);
    e.phasedRegistrationNames ? Q(f) : R(f);
...
for (X in P) W.Simulate[X] = da(X);

function ea(a, b) {
  return function (c, e) {
    var d = new U(a);
    g(d, e);
    W.isDOMComponent(c) ? (c = K(c), d.target = c, T(b, d)) : c.tagName && (d.target = c, T(b, d));
  };
}
